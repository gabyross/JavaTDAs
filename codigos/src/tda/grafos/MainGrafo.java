...
public class MainGrafo {
	...
	// m�todo que recibe un grafo y devuelva su matriz de adyacencia.
	// Por supuesto, tambi�n se debe devolver el vector que relacione nodos con
	// �ndices.
	...
	/*
	 * Dado un Grafo G y un v�rtice v, calcular el conjunto de v�rtices
	 * AdyacentesDobles de v. Se define que un v�rtice w es adyacente doble de un
	 * v�rtice v, si existe otro v�rtice x y hay una arista que comienza en v y
	...
	// Dado un v�rtice v de un grafo, calcular el mayor de los costos de las aristas
	// salientes.
	...
	/*
	 * Dado un Grafo G y un v�rtice v, escribir un m�todo que permita obtener el
	 * conjunto de los Predecesores del v�rtice v en G. Se define que un v�rtice o
	 * es predecesor de otro v�rtice d, si hay una arista que comienza en o y
	 * termina en d.
	 */
	...
	/*
	 * Dado un Grafo G escribir un m�todo que permita obtener el conjunto de los
	 * v�rtices aislados en G. Se define que un v�rtice v es aislado si v no tiene
	...
	/*
	 * Dado un Grafo G y dos v�rtices v1 y v2, escribir un m�todo que permita
	 * obtener el conjunto de todos los v�rtices puente entre v1 y v2. Se define que
	 * un v�rtice p es puente entre dos v�rtices o y d, si hay una arista que
	...
	/*
	 * Dado un Grafo G y un v�rtice v, calcular el grado de v. Se define el grado de
	 * un v�rtice v como el entero que es igual a la resta entre la cantidad de
	...
	// Escriba un m�todo que reciba como entrada un grafo (o sea, un objeto
	// de tipo GrafoTDA) y devuelva true si el grafo est� topol�gicamente
	// ordenado y false en caso contrario.
	// Un grafo est� topol�gicamente ordenado si toda arista se dirige
	// siempre desde un v�rtice menor hacia otro mayor.
